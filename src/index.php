    ...
    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel" >
      <div class="carousel-inner" >
        <div class="carousel-item active">
          <img src="imagens/rells1.jpg" class="d-block w-100" alt="..."  style="height: 700px;">
        </div>
        ...
        <div class="carousel-item ">
          <img src="imagens/rells2.jpg" class="d-block w-100" alt="..." style="height: 700px;">
        </div>
        <div class="carousel-caption d-none d-md-block">
          <h3>Reduzir, Reciclar e Reutilizar</h3>
          <p></p>
        ...
        <div class="carousel-item ">
          <img src="imagens/rells3.jpg" class="d-block w-100" alt="..." style="height: 700px;">
        </div>
        <div class="carousel-caption d-none d-md-block">
          <img src="imagens/icons/reciclagemImg.png" alt="" style="height: 60px;">
          <h3>Reduzir, Reciclar e Reutilizar</h3>
          <p></p>
        </div>
      </div>
  ...
  <section id="trashcoin">
    <div class="container my-5">
      ...
      <div class="container justify-content-center text-center my-5">
        <div class="row  px-2 ">
          <div class="col">
            <img style="height: 80px;" src="imagens/icons/trash3.svg" alt="">
            <p class="h5">Leve produtos e materiais recicláveis ou usados a um ponto de coleta</p>
          </div>
          <div class="col">
            <img style="height: 80px;" src="imagens/icons/arrow-right.svg" alt="">
          </div>
          <div class="col">
            <img style="height: 80px;" src="imagens/icons/wallet2.svg" alt="">
