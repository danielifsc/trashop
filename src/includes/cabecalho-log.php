  ...
  <div class="wrapper container">
    <nav class="navbar navbar-expand-lg bg-light shadow-sm fixed-top mb-5">
      <div class="container-fluid">
        ...
        <p class="d-inline-block align-text-bottom"><?php if (isset($_SESSION["usuario"])) {
        ...
        <div class="collapse navbar-collapse ms-auto" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="./index-log.php#">Início</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="./produtos.php">Produtos</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="./carteira.php">Carteira(trashcoin)</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="./index-log.php#about-us">Sobre nós</a>
            </li>
            <li class="nav-item">
